...
const CTASection = () => {
  ...
  return (
    <section id="donate" className="relative py-20 sm:py-24 md:py-32 overflow-hidden" ref={ref}>
      <img
        src={ctaBg}
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          ...
          <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl text-primary-foreground leading-tight mb-4 sm:mb-6">
            Together, We Can{" "}
            <span className="text-gradient-gold">Transform Nigeria</span>
          </h2>
          <p className="font-body text-primary-foreground/80 text-base sm:text-lg leading-relaxed mb-8 sm:mb-10">
